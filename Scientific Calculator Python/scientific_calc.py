...
lblDisplay = Label(calc, text = "Yourdanov@Python",
                   font=('Helvetica',30,'bold'),
                   bg='cyan',fg='blue',justify=CENTER)
 
lblDisplay.grid(row=0, column= 4,columnspan=4)
 
def iExit():
    iExit = tkinter.messagebox.askyesno("Yourdanov@Python",
